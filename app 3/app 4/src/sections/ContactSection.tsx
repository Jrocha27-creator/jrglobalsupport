...
const CONTENT = {
  pt: {
    label: 'FALE CONOSCO',
    heading: 'ESCOLHA SEU PAÍS E ENTRE EM CONTATO',
    body: 'Nossos especialistas estão prontos para ajudar você. Escolha o país onde está e fale conosco pelo WhatsApp para um atendimento personalizado.',
    badges: [
