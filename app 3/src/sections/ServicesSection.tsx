...
const CONTENT = {
  pt: {
    ...
    heading: 'SOLUCOES JURIDICAS GLOBAIS',
    subtext:
      'Oferecemos suporte juridico completo e personalizado para atender as suas necessidades em diferentes paises e areas do direito.',
    services: [
      {
        icon: FileCheck,
        title: 'APOIO DOCUMENTAL',
        desc: 'Auxilio na organizacao, conferencia e preparacao inicial de documentos. Garantimos que toda a documentacao esteja em ordem para analise juridica.',
      },
      {
        icon: FolderOpen,
        title: 'ORGANIZACAO DE DOCUMENTOS',
        desc: 'Estruturacao de documentos para facilitar analise e encaminhamento. Organizamos processos e papeis de forma clara e eficiente.',
      },
      {
        icon: UserCheck,
        title: 'ENCAMINHAMENTO HABILITADO',
        desc: 'Encaminhamento responsavel para advogado ou profissional habilitado quando necessario. Conectamos voce ao especialista certo.',
      },
      {
        icon: ClipboardList,
        title: 'ACOMPANHAMENTO ADMINISTRATIVO',
        desc: 'Suporte no acompanhamento de procedimentos administrativos e comunicacao com partes envolvidas. Estamos ao seu lado em cada etapa.',
      },
      {
        icon: Globe,
        title: 'BRASILEIROS NO EXTERIOR',
        desc: 'Apoio especializado para brasileiros com interesses no Brasil, Portugal e Reino Unido. Resolvemos questoes juridicas transnacionais.',
      },
      {
        icon: Compass,
        title: 'ORIENTACAO INICIAL',
        desc: 'Primeiro atendimento para entender a situacao e indicar o caminho adequado. Analisamos seu caso e tracamos a melhor estrategia.',
      },
    ],
  },
  en: {
