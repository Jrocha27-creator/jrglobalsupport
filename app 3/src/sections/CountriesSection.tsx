...
const CONTENT = {
  pt: {
    ...
    heading: 'PRESENCA EM TRES PAISES',
    countries: [
      {
        name: 'BRASIL',
        flag: '/assets/flag-brazil-hd.png',
        desc: 'Atendimento completo para brasileiros no exterior e interessados em processos no Brasil. Suporte especializado em diversas areas do direito.',
      ...
      },
      {
        ...
        desc: 'Suporte juridico para brasileiros no Reino Unido. Orientacao especializada no sistema juridico britanico.',
