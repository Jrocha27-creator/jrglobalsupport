...
const CONTENT = {
  pt: {
    ...
    headline: 'CONECTANDO VOCE A SOLUCOES JURIDICAS, ONDE VOCE ESTIVER.',
    subheadline:
      'Atuamos no Brasil, Portugal e Reino Unido oferecendo suporte juridico especializado com excelencia, etica e compromisso com resultados.',
