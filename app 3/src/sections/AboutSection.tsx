...
const CONTENT = {
  pt: {
    label: 'SOBRE NOS',
    heading: 'EXCELENCIA, ETICA E COMPROMISSO GLOBAL',
    body1: 'A JR Global Support e uma assessoria juridica internacional comprometida em oferecer solucoes juridicas inteligentes, personalizadas e eficientes para pessoas fisicas e juridicas em diferentes paises.',
    body2: 'Com atuacao solida no Brasil, Portugal e Reino Unido, unimos conhecimento juridico, experiencia internacional e atendimento humanizado para entregar resultados com seguranca e confianca.',
    values: [
      { icon: Shield, title: 'MISSAO', desc: 'Oferecer solucoes juridicas internacionais com excelencia, etica e comprometimento' },
      { icon: Eye, title: 'VISAO', desc: 'Ser referencia global em assessoria juridica internacional' },
      { icon: Gem, title: 'VALORES', desc: 'Etica e Transparencia · Excelencia Tecnica · Compromisso com Resultados' },
      { icon: Handshake, title: 'DIFERENCIAL', desc: 'Atendimento personalizado, advogados especializados, solucoes sob medida' },
    ],
